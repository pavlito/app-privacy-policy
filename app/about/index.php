...
<html lang="en">
    <head>
        ...
        <title>About Privacy Policy Online</title>
    ...
    <body>
        <div class="wrapper">
            ...
            <!-- Page Hero Main -->
            <section class="sect-hero-main">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-6">
                            <h1>About App <span class="text-primary">PrivacyPolicy</span></h1>
                            <p class="mt-4">AppPrivacyPolicy was built by a group of web developers who have a number of sites, and for each of them we needed to quickly develop a Privacy Policy in order to comply with the ToS (Terms of Service) as required by Google AdSense and other networks.</p>
                            <p>Additionally, a Privacy Policy is now a required legal contract across the world (CCPA, CalOPPA, GDPR), so it has become an extremely useful tool!</p>
                            <p>If you like this AppPrivacyPolicy Generator, share it!</p>
                        </div>
                        <div class="col-lg-6 text-center mt-3 mt-lg-0">
                            <img src="/assets/images/img2.svg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </section>
